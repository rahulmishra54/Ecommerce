...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0c] px-4 relative overflow-hidden">
      {/* ambient glow */}
      <div className="pointer-events-none absolute top-1/4 -right-32 w-96 h-96 bg-purple-700/20 rounded-full blur-[120px]" />
      <div className="pointer-events-none absolute bottom-1/4 -left-32 w-96 h-96 bg-violet-600/15 rounded-full blur-[120px]" />
      ...
      <div className="w-full max-w-md relative">
        <div className="border border-neutral-800 rounded-2xl p-8 md:p-10 bg-white/[0.03] backdrop-blur-sm shadow-[0_0_50px_-15px_rgba(147,51,234,0.25)]">
          ...
          <p className="text-sm text-neutral-500 text-center mb-8">
            Join FOREVER and start shopping
          </p>
          ...
          {success && (
            <p className="text-green-400 text-sm mb-5 text-center bg-green-500/10 border border-green-500/20 rounded-lg py-2 px-3">
          ...
          <form onSubmit={signUp} className="space-y-4">
            <input
              ...
              className="w-full bg-neutral-900/60 border border-neutral-800 rounded-xl px-4 py-3 text-sm text-neutral-100 placeholder:text-neutral-600 outline-none focus:border-purple-600 transition-colors duration-200"
            />
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-neutral-900/60 border border-neutral-800 rounded-xl px-4 py-3 pr-11 text-sm text-neutral-100 placeholder:text-neutral-600 outline-none focus:border-purple-600 transition-colors duration-200"
              />
              <button
                type="button"
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-2 text-sm text-neutral-500 pt-1">
